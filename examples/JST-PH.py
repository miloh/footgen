...
# excerpt of footgen builder for PH headers from https://github.com/miloh/gpcb-footprints 
# implements SMT top entry board headers for JST PH type idc/crimp wire to board header connects
...
# silk at the back
    ...
    f.silk_line( +PH_dimB[i]/2 , f.padwidth/2-2.0, +PH_dimB[i]/2 , f.padwidth/2+0.25 )
    f.sm_pads(pitch = f.pitch, width = f.width ,height=f.height ,pinswide=5, padwidth=f.padwidth, padheight=f.padheight)
